...
@Component({
    selector: 'formulario-visitor',
    templateUrl: 'formulario.template.html'
})
export class FormularioVisitorComponent {
    ...
    guardar() {
        swal({
            ...
            if (result.value) {
                this._toast.get({ tipo: 'success', titulo: 'operación exitosa.', contenido: "El evento ha sido registrado." });
                $("#formulario-visitor").modal("hide");
            }
        });
    }
}
